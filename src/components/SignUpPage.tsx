...
const SignUpPage: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-mesh section-padding overflow-hidden flex items-center justify-center py-12">
      {/* SEO Head */}
      <SEOHead
        title="Sign Up - BuildFlow"
        description="Create an account on BuildFlow to start building amazing digital experiences. Join our community today!"
        keywords="signup, register, BuildFlow, create account, digital experiences"
      ...
      <div className="absolute inset-0 dark:hidden">
        ...
        <div className="absolute top-1/4 right-1/3 w-28 h-28 bg-gradient-to-r from-green-400/25 to-blue-400/25 rounded-full blur-2xl float"></div>
      </div>
      ...
      <div className="absolute inset-0 hidden dark:block">
        ...
        <div className="absolute bottom-1/3 left-1/3 w-36 h-36 bg-gradient-to-r from-green-500/8 to-teal-500/8 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '3s' }}></div>
      </div>
      ...
      <div className="container relative z-10 max-w-md mx-auto">
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-slate-400 leading-relaxed">
                Create your account and start building amazing digital experiences today
              </p>
            </div>
            ...
            >
              {isLoading ? (
                <Loading variant="button" size="sm" message="Signing up with Google..." />
              ) : (
                <>
              ...
              <div className="flex items-start space-x-3">
                <div className="flex items-center h-5">
                  <input
                    ...
                    id="acceptTerms"
                    type="checkbox"
                    className="w-4 h-4 text-primary-600 bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded focus:ring-primary-500 dark:focus:ring-blue-400 focus:ring-2 transition-colors duration-200"
                  />
                </div>
                <div className="text-sm">
                  <label htmlFor="acceptTerms" className="text-gray-700 dark:text-gray-300">
                    I agree to the{' '}
                    <Link to="/terms" className="text-primary-600 dark:text-blue-400 hover:text-primary-500 dark:hover:text-blue-300 transition-colors duration-200 font-medium">
                      Terms of Service
                    </Link>
                    {' '}and{' '}
                    <Link to="/privacy" className="text-primary-600 dark:text-blue-400 hover:text-primary-500 dark:hover:text-blue-300 transition-colors duration-200 font-medium">
                      Privacy Policy
                    </Link>
                  </label>
                  {errors.acceptTerms && (
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            ...
            { icon: Star, title: 'Premium', desc: 'Access to all features' }
          ].map((feature, index) => (
            <div
              key={index}
