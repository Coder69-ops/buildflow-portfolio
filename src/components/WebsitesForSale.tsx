...
const WebsiteCard: React.FC<WebsiteCardProps> = ({
  ...
  return (
    <div className="card p-0 h-full flex flex-col hover-lift hover-glow overflow-hidden group bg-gradient-card">
      <div className="relative overflow-hidden rounded-t-3xl">
        <img
          src={image}
          alt={name}
          className="w-full h-64 object-cover transition-all duration-700 group-hover:scale-115 group-hover:rotate-1"
        />
        ...
        {/* Enhanced badges */}
        <div className="absolute top-6 left-6 glass-card px-4 py-2 rounded-2xl backdrop-blur-xl">
          <span className="text-sm font-bold text-primary-700 drop-shadow-sm">{type}</span>
        </div>
        {rating && (
          <div className="absolute top-6 right-6 glass-card px-4 py-2 rounded-2xl flex items-center space-x-2 backdrop-blur-xl">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500">
          {demoLink && (
            <a
              ...
              className="glass-card px-8 py-4 rounded-2xl flex items-center space-x-3 hover:bg-white/30 transition-all duration-300 magnetic transform translate-y-4 group-hover:translate-y-0"
            >
      ...
      <div className="flex-grow p-8">
        <h3 className="text-2xl font-black text-gray-900 mb-4 group-hover:text-gradient-vibrant transition-all duration-300">{name}</h3>
      ...
      <div className="border-t border-white/20 p-8 mt-auto bg-gradient-to-r from-gray-50/50 to-white/50 backdrop-blur-sm">
        <div className="flex items-center justify-between mb-8">
          <div>
            <span className="text-4xl font-black text-gradient-vibrant drop-shadow-sm">{price}</span>
            <span className="text-gray-500 ml-3 font-bold">one-time</span>
          </div>
        </div>
...
const WebsitesForSale: React.FC = () => {
  ...
  return (
    <section id="for-sale" className="section-padding bg-gradient-primary relative overflow-hidden">
      {/* Enhanced background elements */}
      <div className="absolute inset-0 bg-noise opacity-10"></div>
      <div className="absolute top-32 left-16 w-72 h-72 bg-gradient-to-r from-accent-400/25 to-primary-400/25 rounded-full blur-3xl float-slow"></div>
      <div className="absolute bottom-32 right-16 w-96 h-96 bg-gradient-to-r from-primary-400/25 to-accent-400/25 rounded-full blur-3xl float"></div>
      ...
      <div className="container relative z-10">
        <div className="text-center mb-24">
          <div className="animate-fade-in-up">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md border border-white/30 rounded-full px-6 py-3 mb-8 glass-card">
              ...
              <span className="text-sm font-bold text-gray-700">Premium Templates</span>
              <span className="w-2 h-2 bg-primary-600 rounded-full animate-pulse"></span>
            </div>
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-black text-gray-900 mb-8 leading-tight">
              Ready-Made{' '}
              <span className="text-gradient-vibrant">Templates</span>
            </h2>
        ...
        <div className="text-center animate-fade-in-up delay-600">
          <div className="glass-card rounded-3xl p-12 max-w-4xl mx-auto hover-lift hover-glow">
            <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-8 text-gradient-vibrant">
